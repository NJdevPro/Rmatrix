...
fn main() {
    ...
    let mut s1 = RMatrix{elem: vec![1.,-2.,2.,-1.], rows: 2, cols: 2};
    let s2 = RMatrix{elem: vec![3.,4.,-1.,2.], rows: 2, cols: 2};
    println!("s1 = {:?}", s1);
    println!("s2 = {:?}", s2);
    ...
    let s4 = RMatrix{elem: vec![1.,3.,5.,2.,4.,6.], rows: 2, cols: 3};
    let s5 = RMatrix{elem: vec![-1.,1.,2.,3.,0.,-2.], rows: 3, cols: 2};
    println!("s4 = {:?}", s4);
    println!("s5 = {:?}", s5);
